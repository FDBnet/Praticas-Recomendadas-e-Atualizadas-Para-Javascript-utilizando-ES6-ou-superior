# 134 Melhores Práticas em JavaScript (2024)
...
```sh
git clone https://github.com/FDBnet/Praticas-Recomendadas-e-Atualizadas-Para-Javascript-utilizando-ES6-ou-superior.git
```
